import pytest
from src.day04b import number_of_winning_numbers_for_line, day_four_b
...
def test_parse_line(test_input: str, expected: int) -> None:
    assert number_of_winning_numbers_for_line(test_input) == expected


def test_day_four_b():
    assert day_four_b(input_example) == 30
